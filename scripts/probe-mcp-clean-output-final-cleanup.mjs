...
const docs = scanDocs([
  ...
  'plugins/alembic-codex/runtime/skills/alembic-create/SKILL.md',
  'plugins/alembic-codex/runtime/skills/alembic-recipes/SKILL.md',
  'plugins/alembic-codex/runtime/skills/alembic-guard/SKILL.md',
