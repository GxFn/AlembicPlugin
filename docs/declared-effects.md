...
| Knowledge write | submit_knowledge, evolve, consolidate, dimension_complete, project_skill, knowledge_lifecycle (admin) | Writes confined to the data root (DB + knowledge projections + skill exports under the project's `.agents/skills`); CKG3 evidence gates precede persistence. |
