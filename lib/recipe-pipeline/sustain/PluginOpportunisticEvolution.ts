import type {
  GitDiffScanner,
  GitDiffScanResult,
} from '#recipe-pipeline/sustain/git-diff-checkpoint/GitDiffScanner.js';
import type { UnifiedEvolutionReport } from '#recipe-pipeline/sustain/HostAgentFileChangeHandler.js';
