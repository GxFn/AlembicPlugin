...
import {
  ProjectRuntimeContextV3Schema,
  StrictUnavailableProjectRuntimeContextV3Schema,
  StrictUnavailablePublicationProvenanceSchema,
} from '../project-runtime-output-schema.js';
import {
