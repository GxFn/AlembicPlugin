...
const PLUGIN_OWNED_BOUNDARIES: ModuleBoundaryEntry[] = [
  {
    ...
    sourceOfTruth: 'lib/host-runtime/mcp/** and lib/host-runtime/**',
  },
  {
    ...
    retainedInPlugin: true,
    sourceOfTruth:
      'lib/host-runtime/mcp/handlers/host-agent/** + lib/recipe-pipeline/generate/** with @alembic/core/host-agent-workflows',
  },
  {
  ...
  },
  {
    ...
    retainedInPlugin: true,
    sourceOfTruth: 'lib/host-runtime/context/HostProjectAlignment.ts',
  },
];
